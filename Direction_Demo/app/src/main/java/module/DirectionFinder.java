...
public class DirectionFinder {
    ...
    private static final String GOOGLE_API_KEY = "AIzaSyCGPmIqEbYuA_agLnx_k08Fxb_CzzXnIEg";
    ...
    private String createUrl() throws UnsupportedEncodingException {
        ...
        return DIRECTION_URL_API + "origin=" + urlOrigin + "&destination=" + urlDestination +"&region=sg" + "&language=en" + "&key=" + GOOGLE_API_KEY;
    }
    ...
    private String htmlConverter(String str){
        String noHtml = str.replaceAll("<[^>]*>", "");
        return noHtml;
    }
}
